...
```{r}
#| label: fig-eda1
#| fig-cap: "Missingness Pattern Across Key Variables"
#| fig.height: 6
#| fig.width: 6
...
```{r}
#| label: fig-eda3
#| fig-cap: "Missing Heatmap by Quarter"
...
```{r}
#| label: fig-eda5
#| fig-cap: "Age Distribution by Site"
...
ggplot(psrf_beta, aes(x = Point_Est, y = reorder(Parameter, Point_Est))) +
  ...
  labs(
    y = "",
    x = expression(hat(R)),
    title = "Gelman–Rubin Diagnostic for Beta Parameters"
  )
```

```{r, fig.height=6, fig.width=8}
#| label: fig-bay3
#| fig-cap: "Posterior vs. Prior Distributions for Beta Parameters"
...
```{r}
#| label: fig-bay4
#| fig-cap: "Autocorrelation Plots for Beta Parameters"
#| fig-width: 8
#| fig-height: 6
...
```{r}
#| label: fig-bay5
#| fig-cap: "ROC Plot for Bayesian Model"
