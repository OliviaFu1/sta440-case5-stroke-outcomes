...
$$
$$\begin{aligned}
\text{logit}\{P(\text{homeOrRehab}=1)\}&= \beta_0  + \beta_{\text{EMS}}  + \beta_{\text{PreHospNotify}}  + \beta_{\text{TPA}}  + \beta_{\text{Thrombectomy}}  + \beta_{\text{TPAComp}}  + \beta_{\text{ThrombComp}} \\&\quad + \beta_{\text{Age}}  + \beta_{\text{Period}}  + \beta_{\text{Gender}}  + \beta_{\text{Race}}  + u_{\text{siteID}}
\end{aligned}$$
$$
