...
# Ensure siteID is an integer factor
...
# Only Age should depend on site (random intercept)
pred_matrix["Age", "siteID"] <- -2
pred_matrix[c("Race2","EMSvsCar","PreHospNotify","homeOrRehab"), "siteID"] <- 1
